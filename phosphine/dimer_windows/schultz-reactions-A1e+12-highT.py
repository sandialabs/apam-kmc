...
def ArrheniusRate(barrier):
    ...
    A   = 1.0e12
    T   = 773 #default temperature is 593
...
# rate_constant   = FluxRate(3.75e-8)
#
...
# # Rxn 2
#
# elements_before.append(['PH2','u','*','*','*','*'])
# elements_after.append(['u','PH2','*','*','*','*'])
#
...
# # Warschkow B3 ---> B4
#
# elements_before.append(['*','u','PH2','*','*','*'])
# elements_after.append(['*','PH2','u','*','*','*'])
#
...
elements_before.append(['PH2','u','*','u','u','u'])
elements_after.append(['u','u','*','PH2','u','u'])
...
elements_before.append(['u','u','u','PH2','u','*'])
elements_after.append(['PH2','u','u','u','u','*'])
...
rate_constant   = ArrheniusRate(0.44)
#print 'rate constant: ' , rate_constant
#print 1.0/rate_constant
...
rate_constant   = ArrheniusRate(1.86)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['H','u','*','H','u','*'])
elements_after.append(['u','u','*','u','u','*'])

rate_constant   = ArrheniusRate(2.5)
#print rate_constant
print 1.0/rate_constant
...
rate_constant   = ArrheniusRate(2.2)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['H','u','*','PH2','u','*'])
elements_after.append(['u','u','*','u','u','*'])
