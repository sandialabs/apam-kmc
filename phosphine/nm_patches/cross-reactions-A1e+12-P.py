...
elements_before.append(['b','PH','b','u','u','*','*','*','*','*','*','*'])
elements_after.append(['b','P','b','H','u','*','*','*','*','*','*','*'])
coords.append(coordinates)

rate_constant   = ArrheniusRate(1.1)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['b','PH','b','*','u','u','*','*','*','*','*','*'])
elements_after.append(['b','P','b','*','u','H','*','*','*','*','*','*'])
coords.append(coordinates)
...
rate_constant   = ArrheniusRate(1.74)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['u','u','u','H','u','u','*','*','*','*','*','*'])
elements_after.append(['H','u','u','u','u','u','*','*','*','*','*','*'])
...
elements_before.append(['H','u','H','u','u','u','*','*','*','*','*','*'])
elements_after.append(['u','u','H','H','u','u','*','*','*','*','*','*'])

rate_constant   = ArrheniusRate(1.71)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['H','u','H','u','u','u','*','*','*','*','*','*'])
elements_after.append(['H','u','u','u','u','H','*','*','*','*','*','*'])
...
elements_before.append(['u','u','H','H','u','u','*','*','*','*','*','*'])
elements_after.append(['u','u','u','H','u','H','*','*','*','*','*','*'])

rate_constant   = ArrheniusRate(1.27)
#print rate_constant
print 1.0/rate_constant
...
elements_before.append(['H','u','u','u','u','H','*','*','*','*','*','*'])
elements_after.append(['u','u','u','H','u','H','*','*','*','*','*','*'])
