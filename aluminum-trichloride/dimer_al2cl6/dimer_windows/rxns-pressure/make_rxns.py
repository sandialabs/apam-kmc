...
for pressure in pressures:
    f = open('alcl3-rxn-br-modify-P%s.py'%pressure,'w')
    f.write("""#Quinn Campbell 1/21/2021  qcampbe@sandia.gov
...
def FluxRate(pressure,M=33.99758,T=450):
...
# elements_after.append(['AlCl3','u','AlCl3','*','*','*'])
#
# kb  = 8.617e-5 # units of ev/K
...
elements_before.append(['AlCl2','u','AlCl2','u','u','u'])
elements_after.append(['u','u','AlCl2','AlCl2','u','u'])
...
elements_before.append(['u','u','AlCl2','AlCl2','u','u'])
elements_after.append(['AlCl2','u','AlCl2','u','u','u'])
...
elements_before.append(['AlCl2','u','Cl','u','u','*'])
elements_after.append(['AlCl','u','Cl','Cl','u','*'])
...
elements_before.append(['Cl','u','AlCl2','*','u','u'])
elements_after.append(['Cl','u','AlCl','*','u','Cl'])
