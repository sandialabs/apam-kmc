...
def FluxRate(pressure,M=27.668,T=683):
...
# barrier = 0.32
# from numpy import exp as np_exp
# rate_constant   =FluxRate(3.75e-8)#*np_exp(-barrier/(kb*T))
...
elements_before.append(['BH3','u','BH3','*','u','u'])
elements_after.append(['BH3','u','BH2','*','u','H'])
...
elements_before.append(['BH3','u','BH2','*','u','H'])
elements_after.append(['BH3','u','BH3','*','u','u'])
...
# adjusting barrier down 0.1 eV
rate_constant   = ArrheniusRate(1.12)
#print rate_constant
...
#this barrier subject to change!
rate_constant   = ArrheniusRate(0.57)
#print rate_constant
...
elements_before.append(['H','u','*','u','u','*'])
elements_after.append(['u','u','*','H','u','*'])
...
elements_before.append(['*','u','H','*','u','u'])
elements_after.append(['*','u','u','*','u','H'])
...
elements_before.append(['*','BH2','*','u','u','*'])
elements_after.append(['*','brBH','*','H','u','*'])
...
elements_before.append(['*','BH2','*','*','u','u'])
elements_after.append(['*','brBH','*','*','u','H'])
...
elements_before.append(['*','BH3','*','u','u','*'])
elements_after.append(['*','BH2','*','H','u','*'])

#this barrier subject to change!
rate_constant   = ArrheniusRate(1.58)
#print rate_constant
...
elements_before.append(['*','BH2','*','H','u','*'])
elements_after.append(['*','BH3','*','u','u','*'])
...
elements_before.append(['*','BH2','*','*','u','H'])
elements_after.append(['*','BH3','*','*','u','u'])
